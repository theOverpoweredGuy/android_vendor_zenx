...
ALARM_PATH := vendor/zenx/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/zenx/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/zenx/prebuilt/common/media/audio/ringtones
